...
circleBg.addEventListener('click', function() {
  // Update the justifyContentState based on the clicked position
...
// Update circle position and color scheme function
...
updateCirclePosition(); // Set initial circle position
